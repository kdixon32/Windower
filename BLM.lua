...
function init_gear_sets()
    ...
    sets.precast.FC = {
	ammo="Impatiens",
    head={ name="Merlinic Hood", augments={'"Mag.Atk.Bns."+14','"Fast Cast"+3',}},
    body="Nyame Mail",
    hands={ name="Merlinic Dastanas", augments={'"Fast Cast"+5','CHR+4','"Mag.Atk.Bns."+15',}},
    legs={ name="Psycloth Lappas", augments={'MP+80','Mag. Acc.+15','"Fast Cast"+7',}},
    feet={ name="Merlinic Crackows", augments={'"Fast Cast"+5','CHR+6','Mag. Acc.+2',}},
