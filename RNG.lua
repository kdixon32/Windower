...
state.WeaponMode:options('Fomalhaut','Annihilator','Gastraphetes','Fail-Not','Yoichinoyumi','Kaja Sword', 'Tauret', 'Holliday')
state.WeaponMode:set('Kaja Sword')
...
function get_sets()
	...
	sets.Weapons['Holliday'] = {
		main={ name="Malevolence", augments={'INT+2','Mag. Acc.+3','"Mag.Atk.Bns."+3',}},
		sub="Kaja Knife",
		range={ name="Holliday", augments={'"Mag.Atk.Bns."+18','AGI+3','Rng.Acc.+12','Rng.Atk.+21','DMG:+25',}},
		ammo="Achiyal. Bullet",
	}
	...
	Ranged_Weapons = {
		{WeaponMode = "Kaja Sword", Type = "Arrow"},
		{WeaponMode = "Holliday", Type = "Bullet"},
	...
	Ammo.Bullet.TP = "Achiyalabopa Bullet"		-- TP Ammo
	Ammo.Bullet.ACC = "Achiyalabopa Bullet"	-- Accuracy Ammo
	Ammo.Bullet.CRIT = "Achiyalabopa Bullet"	-- Critical Hit Mode Ammo
	Ammo.Bullet.WS = "Achiyalabopa Bullet"		-- Default WS Ammo
	Ammo.Bullet.WSD = "Achiyalabopa Bullet"		-- Weaponskill Damage
	Ammo.Bullet.MAB = "Achiyalabopa Bullet"	-- Magic Accuracy
	Ammo.Bullet.MAG_WS = "Achiyalabopa Bullet"		-- Magic Attack Bonus
	Ammo.Bullet.MACC = "Achiyalabopa Bullet"	-- Magic Weaponskills
	Ammo.Bullet.PHY_WS = "Achiyalabopa Bullet"	-- Physical Weaponskills

	Ammo.Arrow.TP = "Antlion Arrow"			-- TP Ammo
	Ammo.Arrow.ACC = "Antlion Arrow"			-- Accuracy Ammo
	Ammo.Arrow.CRIT = "Antlion Arrow"		-- Critical Hit Mode Ammo
	Ammo.Arrow.WS = "Antlion Arrow"			-- Default WS Ammo
	Ammo.Arrow.WSD = "Antlion Arrow"			-- Weaponskill Damage
	Ammo.Arrow.MAB = "Antlion Arrow"			-- Magic Attack Bonus
	Ammo.Arrow.MACC = "Antlion Arrow"		-- Magic Accuracy
	Ammo.Arrow.MAG_WS = "Antlion Arrow"		-- Magic Weaponskills
	Ammo.Arrow.PHY_WS = "Antlion Arrow"		-- Physical Weaponskills

	Ammo.Bolt.TP = "Achiyalabopa Bullet"			-- TP Ammo
	Ammo.Bolt.ACC = "Achiyalabopa Bullet"			-- Accuracy Ammo
	Ammo.Bolt.CRIT = "Achiyalabopa Bullet"		-- Critical Hit Mode Ammo
	Ammo.Bolt.WS = "Achiyalabopa Bullet"			-- Default WS Ammo
	Ammo.Bolt.WSD = "Achiyalabopa Bullet"			-- Weaponskill Damage
	Ammo.Bolt.MAB = "Achiyalabopa Bullet"			-- Magical Weaponskills
	Ammo.Bolt.MACC = "Achiyalabopa Bullet"		-- Magic Accuracy
	Ammo.Bolt.MAG_WS = "Achiyalabopa Bullet"		-- Magic Weaponskills
	Ammo.Bolt.PHY_WS = "Achiyalabopa Bullet"		-- Physical Weaponskills
	...
	sets.WS = {
		...
		back={ name="Belenus's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10',}}, -- Add Melee Cape
	}
	...
	sets.WS["Empyreal Arrow"] = set_combine(sets.WS.RA, {})
