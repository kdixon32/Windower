...
function init_gear_sets()
    ...
    sets.idle = {ammo="Thew Bomblet",
        ...
        back={ name="Segomo's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}},waist="Black Belt",legs="Qaaxo Tights",feet="Herald's Gaiters"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        ...
        back={ name="Segomo's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}},waist="Black Belt",legs="Qaaxo Tights",feet="Otronif Boots +1"}
    ...
    sets.defense.HP = {ammo="Iron Gobbet",
        ...
        back={ name="Segomo's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}},waist="Black Belt",legs="Hesychast's Hose +1",feet="Hesychast's Gaiters +1"}

    sets.defense.MDT = {ammo="Demonry Stone",
        head="Uk'uxkaj Cap",neck="Twilight Torque",
        body="Otronif Harness +1",hands="Anchorite's Gloves +1",ring1="Defending Ring",ring2="Shadow Ring",
        back={ name="Segomo's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}},waist="Black Belt",legs="Qaaxo Tights",feet="Daihanshi Habaki"}
